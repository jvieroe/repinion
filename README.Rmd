...
`repinion` contains six different continuous color palettes: `epiblue`, `epipurple`, `epigreen`, `epigold`, `epiredblue`, and `epidarkblue`. You choose between these with the `palette` option in `color_epi_c()` and `fill_epi_c()`
